...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=999660896416714783&permissions=8&scope=applications.commands%20bot",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/999660896416714783",
    },
    {
      link: true,
      name: "Organizations",
